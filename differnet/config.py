...
n_coupling_blocks = 8
fc_internal = 512  # number of neurons in hidden layers of s-t-networks
dropout = 0.0  # dropout in s-t-networks
lr_init = 2e-4
n_feat = emb_size  # 128 #emb_size#256 * n_scales # do not change except you change the feature extractor
