...
n_scales = 2  # number of scales at which features are extracted, img_size is the highest - others are //2, //4,...
...
n_transforms = 2  # number of transformations per sample in training
n_transforms_test = 10  # number of transformations per sample in testing
